    ...
    <div className='about-container'>
      ...
      <div className='about-details'>
        ...
        <p className='about-detail'>
          I studied Mechanical Engineering at the University of Arizona. I began my career at Boeing as a Functional Test Manufacturing Engineer for the 777X-8 program,
          a developmental airplane at the time. My manager was aware of my limited experience in Python and asked me to create a web app that would promote team visibility.
          As I started working on the project assigned by my manager, I quickly realized that my true passion lies in software engineering. The process of coding, debugging, and creating
        ...
        <p className='about-detail'>
          ...
          that shape the future of technology. Keep up with my projects and see what I’m working on!
        </p>
        <p className='about-detail'>
